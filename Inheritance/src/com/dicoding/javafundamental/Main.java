...
public class Main {
    public static void main(String[] args){
        ...
        System.out.println("Apakah hewan IS-S Kucing -> " + (hewan instanceof Kucing));
        ...
        //o.makan(); -> eror, karena method makan() tidak ada di class Object
        h.makan();
        k.makan();
        ...
        //object.makan(); -> eror, karena method makan() tidak ada di class Object
        hewanK.makan();
